...
export default function FeaturesPage() {
  return (
    <main className="min-h-screen pt-20" style={{ backgroundColor: C.cream }}>
      ...
      {/* Deep Dive 1: Support Ecosystem Map */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative aspect-square rounded-[3.5rem] shadow-2xl overflow-hidden"
            >
              {/* Actual Map Image - Scaled up slightly to ensure no gaps */}
              ...
              {/* Border Overlay - Ensures border doesn't shrink the map content */}
              <div className="absolute inset-0 border-[10px] border-white rounded-[3.5rem] z-30 pointer-events-none" />

              {/* Map Search Bar Mockup */}
              <div className="absolute top-8 left-8 right-8 z-40">
                <div className="bg-white/95 backdrop-blur-md px-6 py-4 rounded-2xl shadow-xl border border-white/50 flex items-center gap-3">
                ...
                {[
                  ...
                  >
                    <div className="relative">
                      <MapPin className={`w-10 h-10 ${marker.active ? 'text-[#FF6B6B]' : 'text-[#1A4480]'} fill-current opacity-90 drop-shadow-md`} />
            ...
            >
              <h2 className="text-4xl font-bold mb-6" style={{ color: C.textDark, fontFamily: "var(--font-playfair), serif" }}>
                Interactive <br />
                <span style={{ color: C.teal }}>Support Map</span>
              </h2>
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={i} className="flex gap-6 group">
                    <div className="w-14 h-14 rounded-2xl bg-white flex items-center justify-center border border-[#DDD6C8] shadow-sm shrink-0 group-hover:scale-110 transition-transform">
                      <item.icon className="w-7 h-7 text-[#1A4480]" />
                    </div>
                    <div>
                      <h4 className="font-bold text-[#1C2B3A] mb-2 text-lg">{item.title}</h4>
                      <p className="text-base text-[#4A5A6A] leading-relaxed">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
